...
import (
	...
	samplecrdv1 "github.com/bbbmj/k8s-crd-controller-example/pkg/apis/samplecrd/v1"
	clientset "github.com/bbbmj/k8s-crd-controller-example/pkg/client/clientset/versioned"
	networkscheme "github.com/bbbmj/k8s-crd-controller-example/pkg/client/clientset/versioned/scheme"
	informers "github.com/bbbmj/k8s-crd-controller-example/pkg/client/informers/externalversions/samplecrd/v1"
	listers "github.com/bbbmj/k8s-crd-controller-example/pkg/client/listers/samplecrd/v1"
)
...
func (c *Controller) syncHandler(key string) error {
	...
	if err != nil {
		...
		if errors.IsNotFound(err) {
			glog.Warningf("Network: %s/%s does not exist in local cache, will delete it from Neutron ...", namespace, name)
